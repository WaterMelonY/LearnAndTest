...
//    private String cache_dir = "e:/cache/";//用于压缩图片
    private String server = "172.24.10.210";
    private int port = 21;
    private String userName = "WaterMelon";
    private String userPassword = "wen363733696";
...
//    }
    ...
    public FTPFile[] getFirstDirectory() throws IOException {
        return ftpClient.listFiles("", new FTPFileFilter() {
            @Override
